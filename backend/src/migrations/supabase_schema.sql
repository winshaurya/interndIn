-- Supabase bootstrap schema (single source of truth)
-- Run this file inside the Supabase SQL Editor or CLI.
-- Mirrors the app-level schema in /schema.sql so both stay in sync.
